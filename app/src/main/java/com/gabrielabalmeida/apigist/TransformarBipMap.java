...
public class TransformarBipMap implements Transformation<Bitmap> {
    ...
    public TransformarBipMap(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public TransformarBipMap(BitmapPool pool, int radius, int margin) {
